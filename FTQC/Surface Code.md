#Quantum #QEC
**Surface code** is the most widely studied topological quantum error correcting code. It is the default QEC scheme in the [[Quantum resource estimator]] & the leading candidate for fault-tolerant quantum computing on near-term hardware.
...
[[Quantum resource estimator]] selects $d$ automatically based on your error budget & physical error rate assumptions.

## Logical Gates

- **Transversal Clifford gates** (H, S, [[CNOT]]) - applied qubit-by-qubit across code blocks; inherently fault-tolerant
- **T-gate** - NOT transversal in surface code; must be implemented via **magic state distillation** (see [[Quantum resource estimator]] T-factories)
