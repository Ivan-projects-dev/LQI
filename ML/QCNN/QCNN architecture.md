...
1. **Encoding**: Convert classical data (e.g., an image) into an init [[Quantum state]] via a feature map. Each pixel could be mapped to the amplitude or phase of a qubit, or a group of pixels might encode multiple [[Qubits]].
