...
where $A_j∈SU(2)$, $⊗$ is the [[Tensor]] product, & $N(α,β,γ)=exp(i[α_(σxσx)+β_(σyσy)+γ_(σzσz)])$, where $α,β,γ$ are the params that we can adjust.
...
The image above shows a parametrized $2$-qubit unitary circuit for $N(α,β,γ)=exp(i[α_(σxσx)+β_(σyσy)+γ_(σzσz)])$, where $α=π^2−2_θ$, $β=2ϕ−π^2$ & $γ=π^2−2λ$.