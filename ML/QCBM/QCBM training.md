...
2. **Cost Func**: objective is typically measure of **distance** between $pθ(⋅)$ & $π(⋅)$. Examples include:
...
Like a quantum [[Neural network]], a [[QCBM]] can suffer from **barren plateaus** if the circuit is deep or r&omly init, motivating alternative training schemes.
...
for some $c∈N$ & where $(σi)i=1,…,c$ are the Bandwidth params of each Gaussian kernel & $∥⋅∥$ is the $L_2$ norm.
