#ML #Math 
**Perceptron** is artificial neuron defines the $1st$ step into [[Neural network]] (simplest possible [[Neural network]] itself). It represents single neuron with only $1$ input layer, & no hidden layers.
