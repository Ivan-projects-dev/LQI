...
- For instance "computer", "soft" & "machine" are clustered together, indicating their semantic similarity.
- Similarly "lion", "cow" ,"cat" & "dog" form another cluster, representing their shared attrs.
