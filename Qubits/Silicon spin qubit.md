...
**Qubit init:** [[Qubits]] are typically electrons or nuclei in silicon. These spins are init to known state using magnetic fields & microwave pulses. 
...
**Measurement:** state of each qubit is measured using techs like spin-to-charge conversion, where the spin state is converted to electrical signal that can be detected. 