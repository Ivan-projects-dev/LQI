...
**Ising Model** is math model to study ferromagnetism in statistical physics. Ising model was $1st$ proposed by Wilhelm Lenz who gave it as problem to his graduate student Ernst Ising, after whom this model is named. 
...
Configuration of spins yielding the lowest energy is known as the **ground state**. It is NP-Hard to find the ground state of $2D$ Ising model. Thus, finding the ground state is as hard as problems like the Max-Cut problem & the Travelling Salesperson problem. Spins can be arranged in any other config.
