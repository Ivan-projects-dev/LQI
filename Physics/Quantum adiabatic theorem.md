#Math #Physics
**Theorem:** Let [[Time-Dependent Hamiltonian]] $~H(s)$ be [[Hermitian operator]] that varies smoothly as func of $s:=t/T$ for $s∈[0,1]$. For $T$ arbitrarily large, $H(t)=~H(t/T)$ varies arbitrarily slowly as func of $t$. The system is init at $t=0$ in the state $|ψ(0)⟩$ & evolves according to the [[Schrödinger equation]] $iddt|ψ(t)⟩=H(t)|ψ(t)⟩$.
