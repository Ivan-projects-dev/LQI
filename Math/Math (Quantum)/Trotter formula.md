...
In our case where the Hamiltonian is time-dependent, during the small time step, we assume that the Hamiltonian is approx cons, & approx $U(t_k, t_(k−1))$ as $$U(t_k, t_(k−1))≈exp(−iH(t_k)⋅δ_t)$$ where $H(t_k)$ is the Hamiltonian at time $t_k$. Hence,
