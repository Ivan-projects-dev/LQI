...
In the case of AQC, recall that the Hamiltonian at time $t$ is given by $$H(t)=(1−tT)Hi+tTH_f$$Replacing this in the above equation we get: $$U(T,0)≈n∏k=1exp(−i((1−kδtT)Hi+kδtTHf)δt)$$
