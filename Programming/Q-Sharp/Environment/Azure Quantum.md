...
Once you've tested your program in simulation, you can run it on real quantum hardware. When you run a quantum program in Azure Quantum, you create & run **job**. To submit job to the Azure Quantum providers, you need Azure account & quantum workspace.
