...
**Status:** Theoretical improvement. For practical [[RSA]]-2048 ($n = 2048$), the constant factors mean Regev's algorithm is not yet clearly better than optimized [[Shor]] variants in terms of physical resources. Active research area (2023 - present).
