...
```
**Advantage over standard [[Shor]]:** Requires only $O(1)$ [[Qubits]] in the control register ($1$ qubit at time) $+$ target register. Reduces qubit count at the cost of more circuit runs.
