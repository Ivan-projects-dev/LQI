...
[[QPE]] is the original approach to **quantum chemistry simulation** - it estimates the ground-state energy of molecule by running time evolution on quantum computer & reading off the phase.
...
**Overlap requirement**: success probability of [[QPE]] returning $E_0$ equals $|\langle\tilde{\psi}_0|\psi_0\rangle|^2$. Good initial guess is critical.
### QPE vs VQE for quantum chemistry
...
- [Babbush et al. 2018: Encoding Electronic Spectra in Quantum Circuits with Linear T Complexity](https://arxiv.org/abs/1805.03912)
