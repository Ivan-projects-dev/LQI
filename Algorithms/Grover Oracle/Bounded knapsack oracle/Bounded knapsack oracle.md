...
**[[Oracle]] construction**:
1. **Weight check**: compute $W_{\text{total}} = \sum_i w_i q_i$ into [[Ancilla]] register using quantum adders. Mark the state if $W_{\text{total}} \leq W$ (feasible).
...
- [Q# Std.Arithmetic namespace](https://learn.microsoft.com/en-us/qsharp/api/qsharp-core/microsoft.quantum.arithmetic)
