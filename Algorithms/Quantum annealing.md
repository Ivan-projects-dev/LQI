...
With this property, $H$ has real nonpositive off-diagonal [[Matrix]] elements & the ground state of $H$ can be expressed as classical [[Probability distribution]]. Furthermore, computation does not take place in closed system.