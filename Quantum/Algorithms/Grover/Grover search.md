...
**Grover search** can search through an unsorted DB of $N$ items in approx $√N$ steps, compared to an $N$ num of steps for classical computer. [[Grover's algorithm]] showcased another practical app of Quantum computing, reinforcing its potential to solve complex problems $>$ efficiently.
