#SoftDev #Hardware #Math 
[[D-Wave]] is **not** gate-based quantum computer. There are no [[Hadamard]] gates, no CNOTs, no circuit diagrams. It does not run any of the algorithms in standard quantum computing textbooks ([[Grover]], [[Shor]], [[QPE]], [[VQE]]).
...
[[D-Wave]] solves problems expressed as energy funcs. You define math expression over binary variables where lower energy $=$ better solution. Annealer finds the configuration of variables with the lowest energy.
