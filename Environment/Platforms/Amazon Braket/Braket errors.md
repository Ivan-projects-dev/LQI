...
You must create  [[S3]] bucket before submitting cloud or QPU tasks. Bucket name must be unique globally & exist in the same AWS region as your Braket workspace:
```python
