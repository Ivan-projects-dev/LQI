...
- **[[Amazon Braket]]** - you needspecific hardware vendor ([[IonQ]], [[Rigetti]], QuEra) or AWS integration
- **[[D-Wave]]** - your problem is combinatorial optimization that fits [[QUBO]] form
### Decision by Goal
### "I want to learn quantum computing from scratch"
**Best: Azure [[Quantum Katas]] + [[IBM Quantum]] Learning**

Azure Katas give you immediate math feedback - your implementation is tested against the correct statevector, not just "does it run." [[IBM Quantum]] Learning has the best-structured course sequence. Neither requires hardware access to start. Do not start with [[D-Wave]] - it uses different paradigm that will confuse your understanding of gate-based quantum computing.
### "I want to run a circuit on real quantum hardware today"
**Best: [[IBM Quantum]]**

IBM has the most accessible free QPU tier: no credit card, queue time measured in minutes (not hours), & the queue is shared with research users so off-peak access is fast. `SamplerV2` API is straightforward.
...
### "I want to implement & test variational algorithm (VQE, QAOA, QML)"
**Best: [[PennyLane]]**
...
### "I want to know if my algorithm can run on fault-tolerant hardware in $10$ years"
**Best: [[Azure Quantum]] Resource Estimator**

[[QRE]] is the only tool that gives concrete qubit count $+$ runtime estimate for full fault-tolerant implementation. It accounts for error correction overhead, T-factory count, code distance, & qubit model. It is free, requires no account, & runs in $5$ seconds.

[[D-Wave]] is not relevant for fault-tolerant algorithms.
### "I want to solve a combinatorial optimization problem"
**Best: [[D-Wave]] (for [[QUBO]]-expressible problems) or [[QAOA]] via [[PennyLane]]/Qiskit (for gate-based)**
...
### "I want to access multiple different QPUs & compare"
**Best: [[Amazon Braket]]**

Braket is the only SDK that gives unified interface to [[IonQ]] (trapped ion), [[Rigetti]] (superconducting), OQC (superconducting), & QuEra (neutral atom / Rydberg). If your research involves comparing hardware tech, Braket saves you from maintaining four separate SDKs.
...
### "I want to do photonic quantum computing"
**Best: [[Xanadu]] [[Strawberry Fields]] ([[PennyLane]] ecosystem)**

[[Xanadu]] builds photonic quantum computers. [[Strawberry Fields]] is the SDK for **continuous-variable quantum computing**. No other platform in this vault covers such area.
...
### Hardware Connectivity Matters for Your Algorithm
