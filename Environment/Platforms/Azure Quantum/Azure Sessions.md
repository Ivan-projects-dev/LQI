#SoftDev #Python 
**Session** is logical grouping of multiple jobs submitted to the same provider target. Jobs inside session receive **priority queue access**, reducing wait times compared to standalone job submissions.
