...
| ------------------------ | -------------------------- | -------------- | ---------------------- |
| **SV1** (State Vector)   | Exact statevector          | $34$           | $0.075/min             |
| **DM1** (Density Matrix) | Noisy circuits             | $17$           | $0.075/min             |
| **TN1** (Tensor Network) | Sparse/structured circuits | $50$           | $0.275/min             |
...
SDK: `amazon-braket-sdk` (Python). Circuits use `Circuit` objects; analog devices use `AnalogHamiltonianSimulation`.
