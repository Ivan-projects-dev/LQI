...
**Quantum communication** utilizes the principles of quantum mechanics to secure Data transmission. $1$ of its main apps is [[QKD]]**, which ensures that encryption keys are shared securely by encoding info into quantum states, ensuring provably-secure key sharing.
