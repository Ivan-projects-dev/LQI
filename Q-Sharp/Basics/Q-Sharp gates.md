...
$T$ & $T^\dagger$ are most expensive gates on fault-tolerant hardware: $T$-count is the standard resource metric.
...
**`R1`** - phase rotation, leaves $|0\rangle$ unchanged: `R1(theta, q);`  $|0⟩→|0⟩, |1⟩→e^{iθ}|1⟩$
...
**`Exp`** - exponentiation of a [[Tensor]]-product Pauli: `Exp([PauliZ, PauliZ], theta, [q1, q2]);`  $e^{-iθ Z⊗Z}$
